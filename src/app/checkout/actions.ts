...
export async function sendOrderConfirmationEmail(input: z.infer<typeof OrderConfirmationEmailSchema>) {
  ...
  try {
    ...
    const customerMailOptions = {
      ...
      html: `
        <div style="font-family: serif; color: #241010; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #cab973; letter-spacing: 2px;">ATHAH</h1>
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tfoot>
              <tr>
                ...
                <td style="padding: 10px; font-weight: bold; text-align: right; color: #cab973;">${formatPrice(totalAmount)}</td>
              </tr>
            </tfoot>
          </table>
    ...
    const adminMailOptions = {
      ...
      html: `
        <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd;">
          <h2 style="color: #cab973;">Notification: New Order Placed</h2>
          ...
          <a href="https://labelathah.com/admin/orders/${orderId}" style="display: inline-block; padding: 10px 20px; background-color: #cab973; color: white; text-decoration: none; border-radius: 5px;">View Order in Dashboard</a>
        </div>
      `,
      attachments: [
        {
