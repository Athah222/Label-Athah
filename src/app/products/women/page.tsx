...
const womensCategories = ["Vest Coats", "One Piece"];

export default function WomensProductsPage() {
  const firestore = useFirestore();
  const productsQuery = useMemoFirebase(() => query(collection(firestore, 'products'), where('category', 'in', womensCategories)), [firestore]);
    ...
    <MainLayout>
      <div className="container mx-auto px-4 py-12">
        <div className="mb-12 text-center">
          <h1 className="font-headline text-4xl md:text-5xl">Women's Wear</h1>
          <p className="mt-2 text-lg text-muted-foreground">Explore our collection for women</p>
        </div>
